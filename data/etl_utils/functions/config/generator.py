...
Config(
    Title("ETL Utils", "v1.2", "#e25903"),
    SubTitle("Name Colours"),
    Toggle("Name Colours", "etl_name_colours enabled", "name_colours", 
            extra_enable_comm="execute as @a run scoreboard players operation @s etl_set_colour = @s etl_colour", 
            extra_disable_comm="team leave @a\nscoreboard players reset @a etl_set_colour\nscoreboard players reset @a pick_colour"),
